...
ggplot(compare_df_0.4, aes(x = sent_freq, y = reconstruction, color = condition)) + geom_line()
ggplot(compare_df_0.4, aes(x = sent_freq, y = intensity, color = condition)) + geom_line()
ggplot(compare_df_0.4, aes(x = sent_freq, y = R_squared, color = order_of_sim)) + geom_line() + facet_wrap(vars(condition))
```
